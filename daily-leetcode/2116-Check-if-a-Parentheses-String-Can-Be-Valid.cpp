...
public:
    bool canBeValid(string s, string locked) {
        ...
        std::stack<int> OpenParenthesesStack;
        std::stack<int> UnlockedElementStack;
    ...
    while(!OpenParenthesesStack.empty() && !UnlockedElementStack.empty() 
    && OpenParenthesesStack.top() < UnlockedElementStack.top()){
